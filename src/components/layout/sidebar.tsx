    ...
    <>
      ...
      >
        ...
        <nav className="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
          ...
          <a
            href="#"
            className="group flex items-center px-4 py-2.5 text-sm font-medium bg-indigo-50 dark:bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 rounded-lg relative overflow-hidden transition-all duration-200"
          >
